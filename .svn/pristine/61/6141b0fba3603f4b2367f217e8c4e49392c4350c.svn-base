		...
		public static class AnneeBudgetaireConverter implements Converter {
			...
			public Object getAsObject(FacesContext arg0, UIComponent arg1,
				...
				if (arg2 != null && !String.valueOf(arg2).equals("")&& !arg2.contains("------------")) {
					AnneeBudgetaireConverterBean anneeBudgetaireConverterBean = (AnneeBudgetaireConverterBean) FacesContext
							.getCurrentInstance()
							.getApplication()
							.evaluateExpressionGet(
									FacesContext.getCurrentInstance(),
									"#{anneeBudgetaireConverterBean}",
									AnneeBudgetaireConverterBean.class);
