...
public class FrenchNumberToWords {
	private static final String[] dizaineNames = { "", "", "vingt", "trente",
			"quarante", "cinquante", "soixante", "soixante", "quatre-vingt",
			"quatre-vingt" };

	private static final String[] uniteNames1 = { "", "un", "deux", "trois",
			"quatre", "cinq", "six", "sept", "huit", "neuf", "dix", "onze",
			"douze", "treize", "quatorze", "quinze", "seize", "dix-sept",
			"dix-huit", "dix-neuf" };

	private static final String[] uniteNames2 = { "", "", "deux", "trois",
	...
	private static String convertZeroToHundred(int number) {
		...
		case 8:
			if (lUnite == 0) {
				...
				resultat = dizaineNames[laDizaine] + laLiaison
						+ uniteNames1[lUnite];
			}
			break;
		default:
	...
	public static int getDecimalValue(double value) {
		BigDecimal decimal = new BigDecimal(value).setScale(3,
	...
	public static String convertToDinars(double value) {
		...
		result = FrenchNumberToWords.convert(intValue) + " dinars " + "et "
				+ decimalValue + " millimes";
		return result;
	}
}